...
namespace SG
{
    ...
    [AddComponentMenu("")]
    public class ResourceManagerExt : MonoBehaviour
    {
        //obj pool
        private Dictionary<string, Pool> poolDict = new Dictionary<string, Pool>();

        private static ResourceManagerExt mInstance = null;

        public static ResourceManagerExt Instance
        {
            get
            {
                if (mInstance == null)
                {
                    GameObject GO = new GameObject("ResourceManagerExt", typeof(ResourceManagerExt));
                    ...
                    mInstance = GO.GetComponent<ResourceManagerExt>();
